...
export const translations = {
  ta: {
    ...
    categories: "வகைகள்",
    shopNow: "இப்போ Shop பண்ணுங்க",
    editProfile: "Profile Edit பண்ணு",
    save: "Save",
    cancel: "Cancel",
    language: "மொழி",
    myAddress: "என் முகவரி",
    changePhoto: "Photo மாற்று",
    specialOffers: "சிறப்பு ஆஃபர்கள்",
    popularBestSellers: "பிரபலமான Products / Best Sellers",
    newProducts: "புதிய Products",
    allProducts: "அனைத்து Products",
  ...
  en: {
    ...
    popularBestSellers: "Popular Products / Best Sellers",
